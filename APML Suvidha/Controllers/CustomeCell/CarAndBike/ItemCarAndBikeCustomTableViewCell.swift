//
//  ItemCarAndBikeCustomTableViewCell.swift
//  APML Suvidha
//
...
class ItemCarAndBikeCustomTableViewCell: UITableViewCell{
    //MARK: - Properties
    ...
    func setUpLayout(cell: ItemCarAndBikeCustomTableViewCell, item: CarItemModel){
